...
namespace QOLMod
{
    public class Main : MelonMod
    {
        ...
        public bool showOGMenu = false;
        public float currentTime = 1.0f;
        public KeyCode freezeKey = KeyCode.RightAlt;
        public KeyCode menuKey = KeyCode.RightShift;
        public KeyCode ogMenuKey = KeyCode.RightControl; //im hardcoding this because im lazy!!! its gonna be changable later
        ...
        public override void OnUpdate()
        {
            ...
            if (Input.GetKeyDown(ogMenuKey))
            {
                showOGMenu = !showOGMenu;
            }
        }
